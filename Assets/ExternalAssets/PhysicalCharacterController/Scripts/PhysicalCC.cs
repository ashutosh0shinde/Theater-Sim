...
public class PhysicalCC : MonoBehaviour
{
	...
	[Space]
	[Header("Disable Player Capsule")]
	public bool disablePlayerCapsule;
	public MeshRenderer playerCapsuleMeshR;
	...
	private void Update()
	{
        if (disablePlayerCapsule)
        {
            playerCapsuleMeshR.enabled = false;
        }
        else
        {
            playerCapsuleMeshR.enabled = true;
        }
